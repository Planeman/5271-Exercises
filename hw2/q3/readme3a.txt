...
the cookie that was set after logging into that account. Everything is
normal according to the standard cookie format but the part we were
interested in was the cookie value.

It is clear that the first part of the cookie value is the username that
is logged in. Since we weren't sure on the second half of the value we
